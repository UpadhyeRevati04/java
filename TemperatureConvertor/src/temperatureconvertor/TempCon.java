...
public class TempCon extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                  Enter Temprature ");
        ...
        jRadioButton2.setText("Farenhit");
    ...
    if (input.matches("-?\\d+(\\.\\d+)?")) {
        ...
        if (jRadioButton1.isSelected()) { // Celsius to Fahrenheit
            double fahrenheit = (temperature * 1.8) + 32;
            jTextField1.setText(String.format("%.2f °F", fahrenheit));
        } else if (jRadioButton2.isSelected()) { // Fahrenheit to Celsius
            double celsius = (temperature - 32) / 1.8;
            jTextField1.setText(String.format("%.2f °C", celsius));
        } else { // If neither radio button is selected
            jTextField1.setText("Please select a conversion option.");
        }
    } else {
